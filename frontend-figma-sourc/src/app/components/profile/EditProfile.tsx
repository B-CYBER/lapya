...
export const EditProfile = ({ onBack, onSave }: EditProfileProps) => {
      ...
      <div className="flex-1 overflow-y-auto pb-6">
        <Container maxWidth="form">
          ...
          <button
            ...
            style={{
              backgroundColor: hasChanges ? '#3D6BE5' : '#E7E4DD',
              color: hasChanges ? '#FFFFFF' : '#5E6680',
              fontFamily: 'Inter, sans-serif',
              fontSize: '1rem',
              fontWeight: 500,
              border: 'none',
              cursor: hasChanges ? 'pointer' : 'not-allowed',
              boxShadow: hasChanges ? '0 4px 16px rgba(61, 107, 229, 0.2)' : 'none'
            }}
          >
            Save Changes
          </button>
