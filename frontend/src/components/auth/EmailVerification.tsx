    ...
    <div className="w-full min-h-screen flex flex-col" style={{ backgroundColor: '#FBFAF7' }}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center py-8">
        ...
        <button
          ...
          style={{
            backgroundColor: isVerifying ? '#E7E4DD' : '#3D6BE5',
            color: isVerifying ? '#5E6680' : '#FFFFFF',
            fontFamily: 'Inter, sans-serif',
            fontSize: '1rem',
            fontWeight: 500,
            border: 'none',
            cursor: isVerifying ? 'not-allowed' : 'pointer',
            boxShadow: isVerifying ? 'none' : '0 4px 16px rgba(61, 107, 229, 0.2)'
          }}
        >
          {isVerifying ? 'Verifying…' : 'I have verified my email'}
        </button>
