...
interface HomeScreenProps {
  ...
  onMealClick?: (meal: HomeMeal) => void;
  userName?: string;
  userPlan?: 'free' | 'care';
  meals?: HomeMeal[];
  streakDays?: number;
...
export const HomeScreen = ({
  ...
  const allMeals: HomeMeal[] = mealsProp ?? [
    {
      type: 'BREAKFAST',
      name: 'Moin Moin + Pap',
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p style={{
                  ...
                  {tip ?? 'Did you know? Plantain is high in potassium — great for blood pressure, but watch portions if you have kidney concerns.'}
                </p>
              </div>
            </div>
          </div>
