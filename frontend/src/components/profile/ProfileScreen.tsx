...
import { ChevronLeft, Edit3, Crown, Calendar, Heart, Users, Settings, Activity, LogOut } from 'lucide-react';
...
export const ProfileScreen = ({ onBack, onOpenSettings, onOpenCareCircle, onOpenUpgrade, onEditProfile, onOpenHealthMetrics, onSignOut, profile }: ProfileScreenProps) => {
  const userData: ProfileScreenData = profile ?? {
    name: 'Mrs. Adebayo',
    age: 58,
    weight: 72,
    conditions: [
      ...
      <div className="flex-1 overflow-y-auto pb-6">
        <Container maxWidth="content">
          ...
          {onSignOut && (
            <button
              onClick={onSignOut}
              className="w-full mt-6 flex items-center justify-center gap-2 py-4 rounded-2xl transition-all"
              style={{
                backgroundColor: 'transparent',
                border: '1.5px solid #B4533A',
                color: '#B4533A',
                fontFamily: 'Inter, sans-serif',
                fontSize: '0.9375rem',
                fontWeight: 500,
