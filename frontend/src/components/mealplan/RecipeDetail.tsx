...
export const RecipeDetail = ({ recipe, onBack, ingredients: ingredientsProp, steps: stepsProp }: RecipeDetailProps) => {
  const [activeTab, setActiveTab] = useState<'ingredients' | 'steps'>('ingredients');
  const [completedSteps, setCompletedSteps] = useState<number[]>([]);

  const ingredients: RecipeDetailIngredient[] = ingredientsProp ?? [
  ...
  const steps: RecipeDetailStep[] = stepsProp ?? [
